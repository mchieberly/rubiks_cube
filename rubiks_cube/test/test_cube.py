# Malachi Eberly
# test_cube.py
# python3 -m unittest rubiks_cube/test/test_cube.py
...
class TestCubeRotations(unittest.TestCase):
    ...
    def test_front_clockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/fcr.txt", 'r')
    ...
    def test_front_counterclockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/fccr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_back_clockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/bcr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_back_counterclockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/bccr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_top_clockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/tcr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_top_counterclockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/tccr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_bottom_clockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/dcr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_bottom_counterclockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/dccr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_left_clockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/lcr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_left_counterclockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/lccr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_right_clockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/rcr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
    ...
    def test_right_counterclockwise_rotation(self):
        ...
        file = open("rubiks_cube/test/text_files/rccr.txt", 'r')
        cube_string = file.read()
        self.assertEqual(str(self.cube), cube_string)
        file.close()
...
class TestCubeSolved(unittest.TestCase):
    ...
    def test_solved_cube(self):
        file = open("rubiks_cube/test/text_files/solved_cube_string.txt", 'r')
